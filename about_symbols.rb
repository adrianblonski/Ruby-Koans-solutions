...
class AboutSymbols < Neo::Koan
  ...
  # My answer:
  # I think that if we try to compare this against symbols, we automatically create them, so it becomes true
  ...
  # My answer:
  # Symbols cannot be modified and they stay in a memory untill the program
  # finishes it's work, so they become really inefficient when overused
end
